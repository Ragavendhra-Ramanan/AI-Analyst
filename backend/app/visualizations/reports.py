...
class PDFReportGenerator:
    ...
    def create_benchmark_report(self, target_data, insights, chart_paths, output_path):
        ...
        try:
            ...
            story.append(
                Paragraph(
                    f"{company_name} Benchmark Analysis", self.styles["CustomTitle"]
                )
            )
            ...
            story.append(
                Paragraph(f"Report Generated: {date_str}", self.styles["Normal"])
            )
            story.append(Spacer(1, 0.5 * inch))
            ...
            if insights.get("recommendations"):
                story.append(
                    Paragraph("Key Recommendations", self.styles["SectionHeader"])
                )
            ...
            if insights.get("competitive_position"):
                story.append(
                    Paragraph("Competitive Position", self.styles["SectionHeader"])
                )
                story.append(
                    Paragraph(insights["competitive_position"], self.styles["Normal"])
                )
                story.append(Spacer(1, 0.3 * inch))

            # Add charts
            story.append(
                Paragraph("Performance Analysis", self.styles["SectionHeader"])
            )
        ...
        try:
            ...
            basic_info = [
                [
                    "Sector",
                    " > ".join(
                        company_overview.get("sector_hierarchy", ["Not Available"])
                    ),
                ],
                ["Stage", company_overview.get("stage", "Not Available")],
                [
                    "Founded",
                    str(company_overview.get("founding_year", "Not Available")),
                ],
            ...
            if description:
                story.append(
                    Paragraph("Company Description", self.styles["SectionHeader"])
                )
            ...
            if financials:
                ...
                if revenue and revenue.get("amount"):
                    financial_data.append(
                        ["Revenue", format_currency(revenue.get("amount", 0))]
                    )
                ...
                if cac and cac.get("amount"):
                    financial_data.append(
                        [
                            ...
                            format_currency(cac.get("amount", 0)),
                        ]
                    )
                ...
                if aov and aov.get("amount"):
                    financial_data.append(
                        ["Average Order Value", format_currency(aov.get("amount", 0))]
                    )
                ...
                if financial_data:
                    financial_table = Table(
                        financial_data, colWidths=[3 * inch, 2 * inch]
                    )
    ...
    def add_fundraise_analysis_to_story(self, story, target_data):
        ...
        try:
            ...
            story.append(
                Paragraph(f"Current Round: {round_info}", self.styles["Normal"])
            )
            ...
            if amount_raised and amount_raised.get("amount"):
                ...
                story.append(
                    Paragraph(
                        f"Amount Raised: {amount_text} {currency}",
                        self.styles["Normal"],
                    )
                )
            ...
            if post_money and post_money.get("amount"):
                ...
                story.append(
                    Paragraph(
                        f"Post-Money Valuation: {valuation_text} {currency}",
                        self.styles["Normal"],
                    )
                )
            ...
            if lead_investors:
                ...
                story.append(
                    Paragraph(
                        f"Lead Investors: {investors_text}", self.styles["Normal"]
                    )
                )
    ...
    def add_traction_comparison_to_story(self, story, target_data):
        ...
        try:
            ...
            if traction_table_data:
                traction_table = Table(
                    traction_table_data, colWidths=[3 * inch, 2 * inch]
                )
                traction_table.setStyle(
                    TableStyle(
                        [
    ...
    def add_ai_competitive_summary_to_story(self, story, insights):
        ...
        try:
            ...
            # Add section header
            story.append(
                Paragraph("AI-Powered Competitive Analysis", self.styles["CustomTitle"])
            )
            story.append(Spacer(1, 0.3 * inch))
                ...
                if section_content.strip():
                    ...
                    for line in lines:
                        ...
                        if (
                            ...
                            story.append(
                                Paragraph(f"• {clean_line}", self.styles["Normal"])
                            )
                        else:
                    ...
                    if current_paragraph:
                        story.append(
                            Paragraph(
                                " ".join(current_paragraph), self.styles["Normal"]
                            )
                        )
